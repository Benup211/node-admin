...
import {GraphBar} from '../components/common/GraphBar';
import {IGraphBar} from '../interface/Components.Common.IGraphBar';

//BarChart Data
const BarData:IGraphBar[]=[
    {name: 'Jan', value: 400, color: '#8884d8'},
    {name: 'Feb', value: 300, color: '#83a6ed'},
    {name: 'Mar', value: 300, color: '#8dd1e1'},
    {name: 'Apr', value: 200, color: '#82ca9d'},
    {name: 'May', value: 200, color: '#a4de6c'},
    {name: 'Jun', value: 200, color: '#d0ed57'},
]
